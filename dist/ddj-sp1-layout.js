...
export const DDJ_SP1_LAYOUT = [
    ...
    { id: 'button-71-ch4', type: 'button', channel: 4, number: 71, label: 'FX ON 1', section: 'deck-a-buttons' },
    { id: 'button-72-ch4', type: 'button', channel: 4, number: 72, label: 'FX ON 2', section: 'deck-a-buttons' },
    { id: 'button-73-ch4', type: 'button', channel: 4, number: 73, label: 'FX ON 3', section: 'deck-a-buttons' },
    { id: 'button-74-ch4', type: 'button', channel: 4, number: 74, label: 'FX ON 4', section: 'deck-a-buttons' },
    ...
    { id: 'button-13-ch0', type: 'button', channel: 0, number: 13, label: '', section: 'deck-a-buttons' },
    ...
    // Deck B - Top Button Row (FX ON buttons)
    { id: 'button-71-ch5', type: 'button', channel: 5, number: 71, label: 'FX ON 1', section: 'deck-b-buttons' },
    { id: 'button-72-ch5', type: 'button', channel: 5, number: 72, label: 'FX ON 2', section: 'deck-b-buttons' },
    { id: 'button-73-ch5', type: 'button', channel: 5, number: 73, label: 'FX ON 3', section: 'deck-b-buttons' },
    { id: 'button-74-ch5', type: 'button', channel: 5, number: 74, label: 'FX ON 4', section: 'deck-b-buttons' },
    ...
    { id: 'button-13-ch1', type: 'button', channel: 1, number: 13, label: '', section: 'deck-b-buttons' },
    ...
    // Center Controls
    // Row 1 - Deck selection buttons (4 buttons)
    { id: 'button-76-ch6', type: 'button', channel: 6, number: 76, label: 'DECK 3', section: 'center-row-4' },
    { id: 'button-80-ch6', type: 'button', channel: 6, number: 80, label: 'DECK 3', section: 'center-row-4' },
    { id: 'button-77-ch6', type: 'button', channel: 6, number: 77, label: 'DECK 4', section: 'center-row-4' },
    { id: 'button-81-ch6', type: 'button', channel: 6, number: 81, label: 'DECK 4', section: 'center-row-4' },
    // Row 2 - Unknown buttons (2 buttons)
    { id: 'button-114-ch2', type: 'button', channel: 2, number: 114, label: '', section: 'center-row-2' },
    { id: 'button-114-ch3', type: 'button', channel: 3, number: 114, label: '', section: 'center-row-2' },
    // Row 3 - Browser controls
    { id: 'knob-64-ch6', type: 'knob', channel: 6, number: 64, label: 'BROWSER', section: 'center-browser' },
    { id: 'button-65-ch6', type: 'button', channel: 6, number: 65, label: 'SELECT', section: 'center-browser' },
    // Row 4 - View/Area (2 buttons)
    { id: 'button-101-ch6', type: 'button', channel: 6, number: 101, label: 'VIEW', section: 'center-view-area' },
    { id: 'button-103-ch6', type: 'button', channel: 6, number: 103, label: 'AREA', section: 'center-view-area' },
    // Row 5 - Load buttons (2 buttons)
    { id: 'button-70-ch6', type: 'button', channel: 6, number: 70, label: 'LOAD', section: 'center-load' },
    { id: 'button-71-ch6', type: 'button', channel: 6, number: 71, label: 'LOAD', section: 'center-load' },
