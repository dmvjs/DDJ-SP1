...
export class ControlStateManager {
    constructor() {
        ...
        this.modeButtons = [27, 30, 32, 34]; // HOT CUE, ROLL, SLICER, SAMPLER
        // Tempo management
        this.currentTempo = 94;
        this.tempos = [84, 94, 102];
     ...
     */
    handleBeatsKnobChange(channel, value) {
     ...
     */
    handleModeButtonPress(channel, note, velocity) {
        // Only process on button press (velocity > 0)
